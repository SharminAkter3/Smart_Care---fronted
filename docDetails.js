    ...
    div.innerHTML= `
        ...
        <div class="doc-info">
            ...
            ${doctor.specialization.map((item) =>{
                return `<button class='btn btn-secondary'> ${item}</button>`;
            })}
            </p>
            <p class="w-50">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi
            cumque rerum impedit tenetur? Modi accusantium dolorem ullam nemo
            ipsum? Assumenda vitae
            </p>
...
const handleAppointment=()=>{
    ...
    const selected = Array.from(status).find((button)=>
        button.checked);
